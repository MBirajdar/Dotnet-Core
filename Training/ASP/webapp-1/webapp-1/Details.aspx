<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="webapp_1.Details" %>
...
<body>
    ...
    <form  id="form1" runat="server"  > &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Insert your Details:<br />
<br />
First Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<p>
Last Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:TextBox ID="fname" runat="server"></asp:TextBox>
...
<asp:Button ID="submit" BorderColor="Red" BackColor="SkyBlue" runat="server" OnClick="Button1_Click" Text="Submit" ValidationGroup="vg" />
